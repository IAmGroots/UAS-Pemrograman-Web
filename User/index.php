...
if (isset($_POST["submit"])){
  ...
  $result = mysqli_query($koneksi, "INSERT INTO tb_permintaan VALUES (0, '$id_user', '$nama_games')");
  if ($result){
    echo "
      <script>
      ...
      <form action="" href="#aboutMe" method="POST">
        <div class="boxForm">
          ...
          <div class="inputBox">
            ...
            <input type="text" name="nama_games" id="" placeholder="Nama Games" required/>
          </div>
          <div class="inputBox">
            <label for="">Email</label>
            <input type="email" name="" id="" value="<?php echo $data['email'] ?>" readonly/>
          </div>
          <div class="inputBox">
            <label for="">No Telepon</label>
            <input type="tel" name="" id="" value="<?php echo $data['no_hp'] ?>" readonly/>
          </div>
